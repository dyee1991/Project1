...
def win_check(board,mark):
    ...
    return ((board[7] == mark and board[8] == mark and board[9] == mark ) or # across the middle row 
...
def player_choice(board):
    ...
    while position not in [1,2,3,4,5,6,7,8,9] or not space_check(board,position):
      # Could have used range also range(1,10)
...
#Assuming the uer is inputting the correct value
...
while True:
    ...
    while game_on:
        ...
        if turn == 'Player 1':
            ...
            # Place the marker on the positoin
...
# BREAK OUR OF THE WHILE LOOP ON replay()
